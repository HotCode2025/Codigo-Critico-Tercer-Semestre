...
class Raton extends DispositivoEntrada {
    ...
    mostrarDetalles() {
        console.log(`🐭 Ratón - ${this.toString()}`);
    }
}
...
class Teclado extends DispositivoEntrada {
    ...
    mostrarDetalles() {
        console.log(`⌨️ Teclado - ${this.toString()}`);
    }
}
...
class Monitor {
    ...
    mostrarDetalles() {
        console.log(`🖥️ Monitor - ${this.toString()}`);
    }
}
...
class Computadora {
    ...
    mostrarDetalles() {
        console.log(`💻 Computadora - ${this.toString()}`);
    }
}
...
let listaDeObjetos = [raton1, teclado1, monitor1, computadora1, raton2, teclado2, monitor2, computadora2];

for (let objeto of listaDeObjetos) {
    if (typeof objeto.mostrarDetalles === "function") {
        objeto.mostrarDetalles();
    }
}